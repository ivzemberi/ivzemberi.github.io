---
layout: page
title: "Environmental Tote Bag Design"
...
<body>
  <p>Earlier this year, Kaufland Croatia published a design competition
    for students under the slogan: 
    <a class="is-primary" href="https://www.kaufland.hr/akcije-novosti/dizajnom-za-dobre-stvari.html">
        <strong style="color: darkblue">"Students, do you think green?"</strong>.
    </a>
    The assignment was to design an environmentally friendly tote bag. There were four themes to pick from: 
    <strong>1) biodiversity</strong>, <strong>2) climate protection</strong>, <strong>3) food waste</strong>, and
    <strong>4) recycling plastic</strong>.
  </p>
  <p>
  ...
  <p>
    ...
    in researching the customers. I also had their regular tote bags to study and nudge my design in the direction of 
    their brand.
  </p>
  <div class="columns">
    <div class="column">
  ...
  <p>
    ...
    The tool I used for designing the solution was Adobe Illustrator.
  </p>
  ...
  <p>
    ...
    Freepik and Unsplash, and used Adobe Photoshop to put my design on the mockups.
  </p>
  <div class="columns">
    <div class="column">
        <figure>
    ...
    <div class="column">
        <figure>
            ...
            <figcaption>
                Photo by <a href="https://unsplash.com/@mediamodifier?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Mediamodifier</a> on <a href="https://unsplash.com/s/photos/tote-bag?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
            </figcaption>
        </figure>
    </div>
  </div>
